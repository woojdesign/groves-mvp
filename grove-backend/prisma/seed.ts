...
const userPersonas = [
  // Early career / Junior roles
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Mechanical keyboard building and custom keycap design. I love the tactile feedback and the endless customization options.',
      ...
      rabbitHole: 'Learning about different switch types, lubing techniques, and PCB design for custom keyboards',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Film photography with vintage cameras, especially Soviet-era cameras like the Zenit and Kiev series',
      ...
      rabbitHole: 'Developing my own black and white film at home and experimenting with alternative processing techniques',
  ...
  // Mid-career / Individual contributors
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Sourdough bread baking and exploring ancient grain varieties like einkorn and spelt',
      ...
      rabbitHole: 'Reading about the microbiology of fermentation and how different flours affect gluten development',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Urban foraging and learning about edible plants in city environments, especially in neglected spaces',
      project: 'Creating a field guide to edible plants in my neighborhood and teaching foraging basics to community members',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Studying ethnobotany and the history of Indigenous plant knowledge in my region',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Retro computing and restoring vintage computers from the 80s and 90s, especially Commodore and Amiga systems',
      project: 'Restoring a Commodore 64 and learning to code demos in 6502 assembly language',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Exploring the demoscene and understanding how programmers pushed hardware to its absolute limits',
  ...
  // Senior / Leadership roles
  {
    ...
    profile: {
      nicheInterest: 'Bonsai cultivation and Japanese aesthetics, especially the wabi-sabi philosophy',
      ...
      rabbitHole: 'Reading about Zen Buddhism and how it influences Japanese garden design',
  ...
  },
  {
    ...
    role: 'org_admin' as const,
    profile: {
      nicheInterest: 'Letterpress printing and bookbinding, especially creating limited edition artist books',
      project: 'Setting up a small letterpress studio in my garage and learning traditional printing techniques',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Collecting vintage type specimens and studying the history of typography',
  ...
  // Different interest areas
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Mycology and mushroom cultivation, especially growing gourmet and medicinal mushrooms at home',
      project: 'Cultivating lion\'s mane and oyster mushrooms using low-tech methods and experimenting with different substrates',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Learning about the ecological role of fungi and their potential in bioremediation',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Vintage synthesizers and creating ambient music with modular gear and tape loops',
      project: 'Building a home studio focused on generative music systems and releasing monthly ambient albums',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Exploring West Coast synthesis techniques and the philosophy of Brian Eno\'s ambient music',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Fountain pens and handwritten correspondence, especially vintage flex nib pens from the 1920s-40s',
      project: 'Writing weekly letters to friends and family using different vintage pens and learning calligraphy',
      connectionType: 'friendship' as const,
      rabbitHole: 'Studying different ink properties and how they interact with various paper types',
  ...
  // More diverse interests
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Fermentation beyond food - kombucha, kimchi, miso, and experimental ferments with unusual ingredients',
      project: 'Maintaining a fermentation station with 12+ active projects and documenting flavor development over time',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Reading about lactic acid bacteria strains and their role in flavor development',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Urban cycling and bicycle mechanics, especially restoring vintage steel frame bikes',
      project: 'Converting a 1980s Schwinn into a modern single-speed commuter with period-appropriate components',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Learning about bicycle frame geometry and how it affects ride quality',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Zine making and DIY publishing, especially exploring risograph printing and collage techniques',
      project: 'Creating a quarterly zine about local music scenes and teaching zine-making workshops',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Collecting vintage magazines for collage material and studying underground publishing history',
  ...
  // Tech-adjacent interests
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Building mechanical automata and kinetic sculptures inspired by 19th-century clockwork designs',
      project: 'Creating a wooden automaton that writes with a pen, using only gears and cams for movement',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Studying the work of Pierre Jaquet-Droz and modern makers like Cabaret Mechanical Theatre',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Analog electronics and building guitar effects pedals from scratch, especially fuzz and overdrive circuits',
      project: 'Designing and etching my own PCBs for a series of boutique-style effects pedals',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Learning about transistor characteristics and how different components affect tone',
  ...
  // Creative pursuits
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Botanical illustration and nature journaling, combining watercolor painting with scientific observation',
      project: 'Creating a year-long nature journal documenting seasonal changes in my local park',
      connectionType: 'friendship' as const,
      rabbitHole: 'Studying historical botanical illustrators like Maria Sibylla Merian and learning plant identification',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Home coffee roasting and exploring single-origin beans from small farms around the world',
      project: 'Roasting beans in a popcorn popper and developing my cupping skills to better understand flavor profiles',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Learning about coffee processing methods and how they affect flavor - natural vs washed vs honey',
  ...
  // Outdoor/physical activities
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Rock climbing route setting and understanding movement patterns, especially on bouldering problems',
      project: 'Training for outdoor climbing season and learning to read rock features and plan routes',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Studying climbing movement analysis and how body mechanics affect performance',
  ...
  },
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Orienteering and map reading, especially enjoying the challenge of navigation without GPS',
      project: 'Training for orienteering competitions and creating detailed mental maps of local trail systems',
      connectionType: 'collaboration' as const,
      rabbitHole: 'Learning about topographic map interpretation and historical surveying techniques',
  ...
  // Wellness/lifestyle
  {
    ...
    role: 'user' as const,
    profile: {
      nicheInterest: 'Herbalism and making plant-based remedies, tinctures, and salves from garden-grown herbs',
      project: 'Growing a medicinal herb garden and learning about traditional herbal medicine practices',
      connectionType: 'knowledge_exchange' as const,
      rabbitHole: 'Studying the history of folk medicine and modern research on herbal compounds',
...
async function main() {
  ...
  for (const persona of userPersonas) {
    ...
    console.log(`   ✓ ${persona.name} - ${persona.profile.nicheInterest.slice(0, 50)}...`);
  }
